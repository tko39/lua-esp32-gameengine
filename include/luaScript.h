// Auto-generated header file from lua/tictactoe.lua lua/touchSequence.lua lua/sideShooter.lua lua/flappyBird.lua lua/orbit.lua lua/gemfall.lua lua/chess.lua
#ifndef LUASCRIPT_H
#define LUASCRIPT_H
