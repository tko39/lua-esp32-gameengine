// Auto-generated header file from lua/bouncingBalls.lua lua/touchSequence.lua lua/sideShooter.lua lua/rotatingBox.lua lua/bouncingRotatingCubes.lua lua/flappyBird.lua lua/3dApiDemo.lua lua/3dApiDemoBounce.lua lua/orbit.lua lua/gemfall.lua
#ifndef LUASCRIPT_H
#define LUASCRIPT_H
...
local MATCH_HORIZONTAL = 0
local MATCH_VERTICAL = 1
